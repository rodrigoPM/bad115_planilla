          ...
          <div class="card-body row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="invalid-feedback" style="display:none">
                  Usuario no válido: <strong>Debe contener solo letras</strong>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="invalid-feedback" style="display:none">
                  <strong>Debe ser de 8 a 15 caracteres, contener al menos  1 mayúscula y 1 caracter especial</strong>
                </div>
              </div>
              <div class="form-group">
